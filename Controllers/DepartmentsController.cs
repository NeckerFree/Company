...
namespace Company.Controllers
{
    ...
    {
        private readonly StaffDataContext _context;

        public DepartmentsController(StaffDataContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Departments>> PostDepartments(Departments departments)
        {
          if (_context.Departments == null)
          {
              return Problem("Entity set 'StaffDataContext.Departments'  is null.");
          }
